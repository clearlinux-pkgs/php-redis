...
Source0  : https://pecl.php.net/get/redis-6.1.0.tgz
...
%prep
%setup -q -n redis-6.1.0
cd %{_builddir}/redis-6.1.0
pushd ..
cp -a redis-6.1.0 buildavx2
popd
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/extensions/no-debug-non-zts-20240924/redis.so
